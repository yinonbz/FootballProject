...
public class Keys {
    ...
    public static final ForeignKey<MatchFollowersRecord, MatchRecord> FK__MATCH5 = ForeignKeys0.FK__MATCH5;
    public static final ForeignKey<MatchFollowersRecord, SubscribersRecord> FK__SUBSCRIBERS7 = ForeignKeys0.FK__SUBSCRIBERS7;
    ...
    public static final ForeignKey<NotificationsRecord, SubscribersRecord> FK__SUBSCRIBERS5 = ForeignKeys0.FK__SUBSCRIBERS5;
    ...
    public static final ForeignKey<PageFollowersRecord, PagesRecord> FK__PAGES3 = ForeignKeys0.FK__PAGES3;
    public static final ForeignKey<PageFollowersRecord, SubscribersRecord> FK__SUBSCRIBERS6 = ForeignKeys0.FK__SUBSCRIBERS6;
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<MatchFollowersRecord, MatchRecord> FK__MATCH5 = Internal.createForeignKey(Keys.KEY_MATCH_PRIMARY, MatchFollowers.MATCH_FOLLOWERS, "FK__match5", new TableField[] { MatchFollowers.MATCH_FOLLOWERS.MATCHID }, true);
        public static final ForeignKey<MatchFollowersRecord, SubscribersRecord> FK__SUBSCRIBERS7 = Internal.createForeignKey(Keys.KEY_SUBSCRIBERS_PRIMARY, MatchFollowers.MATCH_FOLLOWERS, "FK__subscribers7", new TableField[] { MatchFollowers.MATCH_FOLLOWERS.FOLLOWERID }, true);
        ...
        public static final ForeignKey<NotificationsRecord, SubscribersRecord> FK__SUBSCRIBERS5 = Internal.createForeignKey(Keys.KEY_SUBSCRIBERS_PRIMARY, Notifications.NOTIFICATIONS, "FK__subscribers5", new TableField[] { Notifications.NOTIFICATIONS.SUBSCRIBERID }, true);
        ...
        public static final ForeignKey<PageFollowersRecord, PagesRecord> FK__PAGES3 = Internal.createForeignKey(Keys.KEY_PAGES_PRIMARY, PageFollowers.PAGE_FOLLOWERS, "FK__pages3", new TableField[] { PageFollowers.PAGE_FOLLOWERS.PAGEID }, true);
        public static final ForeignKey<PageFollowersRecord, SubscribersRecord> FK__SUBSCRIBERS6 = Internal.createForeignKey(Keys.KEY_SUBSCRIBERS_PRIMARY, PageFollowers.PAGE_FOLLOWERS, "FK__subscribers6", new TableField[] { PageFollowers.PAGE_FOLLOWERS.FOLLOWERID }, true);
